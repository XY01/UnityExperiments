...
Shader "RaymarchingAmpRepeatingNoise"
{
	Properties
	{
				 ...
				 float denisty = 0;
				   ...
				   float3 center = float3(10, 2, 0);
				    ...
				    for (int i = 0; i < numSteps; i++)
				    {
				        ...
				        float radius = 1;
				        float spherefallOff = 1-saturate(length(rayOrigin - center)/radius);
				        ...
				        denisty += sampleDensity * densityScale * spherefallOff;
...
/*ASEBEGIN
Version=18935
112;608;1535;793;4247.116;623.5046;3.781857;True;False
Node;AmplifyShaderEditor.CommentaryNode;51;-1663.986,1764.787;Inherit;False;446.7869;772.4161;Noise;7;43;47;46;45;48;50;49;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector3Node;17;-1603.536,246.3057;Inherit;False;Property;_offset;offset;5;0;Create;True;0;0;0;False;0;False;0.5,0.5,0.5;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;45;-1612.306,2020.755;Inherit;False;Property;_NoiseOffset;Noise Offset;14;0;Create;True;0;0;0;False;0;False;0,1,0;-0.05,-0.4,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleTimeNode;46;-1624.053,2202.843;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-1508.393,2283.955;Inherit;False;Property;_NoiseStr;Noise Str;15;0;Create;True;0;0;0;False;0;False;0;2.2;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-1498.091,2447.013;Inherit;False;Property;_NoiseDenistyScale;NoiseDenistyScale;17;0;Create;True;0;0;0;False;0;False;1;5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-1509.122,2363.778;Inherit;False;Property;_NoiseScale;NoiseScale;16;0;Create;True;0;0;0;False;0;False;1;0.97;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1413.63,768.2577;Inherit;False;Property;_lightStepSize;lightStepSize;7;0;Create;True;0;0;0;False;0;False;0.06;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-1368.154,2171.705;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1379.796,-207.5515;Inherit;False;Property;_StepSize;StepSize;1;0;Create;True;0;0;0;False;0;False;0.02;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;43;-1448.943,1815.606;Inherit;True;Property;_Noise3D;Noise3D;4;0;Create;True;0;0;0;False;0;False;4ed99a7ccafd728408a1bd580f472384;4ed99a7ccafd728408a1bd580f472384;False;white;LockedToTexture3D;Texture3D;-1;0;2;SAMPLER3D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.IntNode;7;-1385.796,-300.5515;Inherit;False;Property;_NumSteps;NumSteps;0;0;Create;True;0;0;0;False;0;False;32;16;False;0;1;INT;0
Node;AmplifyShaderEditor.CustomExpressionNode;9;-433.661,-55.72034;Inherit;False; float denisty = 0@$    float transmission = 0@$    float lightAccumulation = 0@$    float finalLight = 0@$        $    // Distance$    float totalDist = 0@$    float distToDepth = length(rayOrigin - depthPos)@$$   float3 center = float3(10, 2, 0)@$     $    for (int i = 0@ i < numSteps@ i++)$    {$        if (totalDist > distToDepth)$            break@$            $        totalDist += stepSize@$        rayOrigin += rayDirection * stepSize@$    $        float3 samplingPos = rayOrigin+offset +(noiseOffset * .23)@$        float4 samplePosMip = float4(samplingPos, 0)@$        $        // Sample noise to offset ray/uv$        float4 noiseSamplePos =  float4(samplingPos * noiseScale + noiseOffset, 0)@$        float noiseSample = pow(tex3Dlod(Noise3D,noiseSamplePos).r,noiseStr)@$$        float radius = 1@$        float spherefallOff = 1-saturate(length(rayOrigin - center)/radius)@$        $        // Sample smoke volume tex$        float noiseLookupOffset = noiseSample * normalize(noiseOffset) * .1 * noiseStr@$        samplePosMip.xyz += noiseLookupOffset@$        float sampleDensity = tex3Dlod(Noise3D,samplePosMip).r@$        $        // Scale the noise density contribution$        sampleDensity *= noiseSample * noiseDensityScalar@$        denisty += sampleDensity * densityScale * spherefallOff@$        $        $    $        // Lighting$        float3 lightRayOrigin = samplingPos@$        for (int j = 0@ j < numLightSteps@ j++)$        {$            lightRayOrigin += lightDir * lightStepSize@$            float4 lightRayOriginMip = float4(lightRayOrigin,0)@$            $            // Sample noise$           float4 lightNoiseSamplePos =  float4(samplingPos * noiseScale + noiseOffset, 0)@$            float lightNoiseSample = pow(tex3Dlod(Noise3D,lightNoiseSamplePos).r,noiseStr)@$            $            // Sample volume tex$           noiseLookupOffset = lightNoiseSample * normalize(noiseOffset) * .1 * noiseStr@$            lightRayOriginMip.xyz += noiseLookupOffset@$            float lightDensity = tex3Dlod(Noise3D, lightRayOriginMip).r@$            $            // Scale the noise density contribution$            lightDensity  *= lightNoiseSample * noiseDensityScalar@$            lightAccumulation += lightDensity * densityScale@ $        }$    $        float lightTransmission = exp(-lightAccumulation)@$        float shadow = darknessThreshold + lightTransmission * (1.0 - darknessThreshold)@$        finalLight += denisty * transmittance * shadow@$        transmittance *= exp(-denisty*lightAsorb)@$    }$    $    transmission = exp(-denisty)@$    return float3(finalLight, transmission, transmittance)@;3;Create;19;True;rayOrigin;FLOAT3;0,0,0;In;;Inherit;False;True;rayDirection;FLOAT3;0,0,0;In;;Inherit;False;True;numSteps;INT;0;In;;Inherit;False;True;stepSize;FLOAT;0;In;;Inherit;False;True;densityScale;FLOAT;0;In;;Inherit;False;True;Volume;SAMPLER3D;;In;;Inherit;False;True;offset;FLOAT3;0,0,0;In;;Inherit;False;True;numLightSteps;INT;0;In;;Inherit;False;True;lightStepSize;FLOAT;0;In;;Inherit;False;True;lightDir;FLOAT3;0,0,0;In;;Inherit;False;True;lightAsorb;FLOAT;0;In;;Inherit;False;True;darknessThreshold;FLOAT;0;In;;Inherit;False;True;transmittance;FLOAT;0;In;;Inherit;False;True;depthPos;FLOAT3;0,0,0;In;;Inherit;False;True;Noise3D;SAMPLER3D;;In;;Inherit;False;True;noiseOffset;FLOAT3;0,0,0;In;;Inherit;False;True;noiseStr;FLOAT;1;In;;Inherit;False;True;noiseScale;FLOAT;1;In;;Inherit;False;True;noiseDensityScalar;FLOAT;1;In;;Inherit;False;Raymarch;True;False;0;;False;19;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;INT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;SAMPLER3D;;False;6;FLOAT3;0,0,0;False;7;INT;0;False;8;FLOAT;0;False;9;FLOAT3;0,0,0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT3;0,0,0;False;14;SAMPLER3D;;False;15;FLOAT3;0,0,0;False;16;FLOAT;1;False;17;FLOAT;1;False;18;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;33;-83.58459,-474.9768;Inherit;False;Property;_ShadeCol;ShadeCol;11;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.07547165,0.07547165,0.07547165,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;34;-84.58459,-295.9768;Inherit;False;Property;_LightCol;LightCol;12;0;Create;True;0;0;0;False;0;False;1,0,0,0;0.8490566,0.8490566,0.8490566,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=1D6A12563A1AD99790DC7ED55923DB488BF8BFFC