...
Shader "ProceduralFlame Experimental smoke"
{
	Properties
	{
		...
		_HighFStr("HighF Str", Range( 0 , 1)) = 1
		_Paralaxheight("Paralax height", Range( 0 , 4)) = 0.9882339
		[ASEEnd]_LFParalaxheight("LF Paralax height", Range( 0 , 4)) = 0.9882339
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _LFParalaxheight;
			float _LowFExp;
			float _LowFStr;
			float _HighFUTiling;
			float _HighFVTiling;
			float _HighFScrollSpeed;
			float _Paralaxheight;
			float _HighFExp;
			float _HighFStr;
			float _Alpha;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				Gradient gradient489 = NewGradient( 0, 4, 2, float4( 0, 0, 0, 0 ), float4( 0.09569195, 0.09569195, 0.09569195, 0.4 ), float4( 0.3018868, 0.3018868, 0.3018868, 0.8617685 ), float4( 0.5377358, 0.5351993, 0.5351993, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float2 Offset596 = ( ( _LFParalaxheight - 1 ) * ase_tanViewDir.xy * _LFParalaxheight ) + texCoord5_g24;
				float NoiseLowFreq263 = ( 1.0 - tex2D( _Texture0, Offset596 ).r );
				...
				float2 Offset587 = ( ( _Paralaxheight - 1 ) * ase_tanViewDir.xy * _Paralaxheight ) + texCoord5_g23;
				float NoiseHighFreq262 = ( 1.0 - tex2D( _Texture0, Offset587 ).r );
				float temp_output_293_0 = ( pow( NoiseHighFreq262 , _HighFExp ) * _HighFStr );
				float temp_output_606_0 = ( ( temp_output_280_0 + temp_output_293_0 ) * 0.4 );
				float CombinedNoise356 = temp_output_606_0;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = SampleGradient( gradient489, CombinedNoise356 ).rgb;
				float Alpha = saturate( ( (0.0 + (CombinedNoise356 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) * _Alpha ) );
...
/*ASEBEGIN
Version=18935
648;73;655;756;-1445.438;1425.93;2.007665;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;588;-3286.315,-308.8588;Inherit;False;Property;_Paralaxheight;Paralax height;20;0;Create;True;0;0;0;False;0;False;0.9882339;0;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;594;-3317.469,-1322.583;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;589;-3208.321,-229.2512;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;595;-3395.463,-1402.19;Inherit;False;Property;_LFParalaxheight;LF Paralax height;21;0;Create;True;0;0;0;False;0;False;0.9882339;0;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ParallaxMappingNode;587;-2979.498,-307.2532;Inherit;False;Normal;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ParallaxMappingNode;596;-3088.646,-1400.585;Inherit;False;Normal;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;253;-4079.035,-809.6586;Inherit;True;Property;_Texture0;Texture 0;4;0;Create;True;0;0;0;False;0;False;bb911711ee9d6694e892feafd898faca;bb911711ee9d6694e892feafd898faca;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.OneMinusNode;258;-2741.283,-967.6653;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;285;-2273.643,-913.9195;Inherit;False;Property;_LowFExp;LowF  Exp;13;0;Create;True;0;0;0;False;0;False;1;7.4;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;280;-1823.853,-894.7965;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;293;-1824.243,-564.9339;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;605;-1396.22,-252.4523;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;607;-1314.059,32.71154;Inherit;False;Constant;_Float3;Float 3;22;0;Create;True;0;0;0;False;0;False;0.4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;606;-1059.914,-155.325;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;349;-1257.627,-1049.962;Inherit;False;764.5095;725.9598;Noise combine;4;356;534;539;362;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;356;-688.5675,-670.4678;Inherit;False;CombinedNoise;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;610;1866.721,-131.718;Inherit;True;356;CombinedNoise;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;305;1904.837,141.9387;Inherit;False;754.7336;308.509;Alpha;3;302;303;62;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;62;1924.947,287.5716;Inherit;False;Property;_Alpha;Alpha;1;0;Create;True;0;0;0;False;0;False;1.748938;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;612;2098.636,-57.7251;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;462;426.5205,-626.1403;Inherit;False;1321.329;468.3773;Flame shape;6;433;438;441;432;460;495;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;302;2256.765,192.9449;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LengthOpNode;602;1273.11,-164.8394;Inherit;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;539;-913.2974,-664.6496;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;325;-1537.905,1103.805;Inherit;False;Spherize;-1;;28;1488bb72d8899174ba0601b595d32b07;0;4;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;322;-1527.684,845.7273;Inherit;False;Spherize;-1;;29;1488bb72d8899174ba0601b595d32b07;0;4;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.PowerNode;608;-689.0321,-71.58847;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;11.44;False;1;FLOAT;0
Node;AmplifyShaderEditor.LengthOpNode;438;1315.202,-526.7167;Inherit;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;603;1547.94,-168.321;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1.47;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;604;1443.224,-156.89;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;601;1018.734,-166.4292;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,2;False;1;FLOAT2;-1,-1;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;534;-1189.313,-668.1078;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;303;2461.573,196.4477;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;441;921.4126,-295.5737;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.49;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;405;-5433.663,179.0955;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SinOpNode;500;-5975.893,539.8688;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;495;742.0838,-235.9136;Inherit;False;Constant;_Float2;Float 2;16;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientNode;489;1761.507,-790.8671;Inherit;False;0;4;2;0,0,0,0;0.09569195,0.09569195,0.09569195,0.4;0.3018868,0.3018868,0.3018868,0.8617685;0.5377358,0.5351993,0.5351993,1;1,0;1,1;0;1;OBJECT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;362;-1201.36,-923.7858;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;587;3;589;0
WireConnection;596;0;583;0
WireConnection;596;1;595;0
WireConnection;596;2;595;0
WireConnection;596;3;594;0
WireConnection;250;0;253;0
WireConnection;250;1;587;0
WireConnection;239;0;253;0
WireConnection;239;1;596;0
...
WireConnection;605;0;280;0
WireConnection;605;1;293;0
WireConnection;606;0;605;0
WireConnection;606;1;607;0
WireConnection;356;0;606;0
WireConnection;612;0;610;0
WireConnection;302;0;612;0
...
ASEEND*/
//CHKSM=9FEE23AD36A0C3EC4B5D76CEEFDD948D7EE9C1F1