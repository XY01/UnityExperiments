...
Shader "ProceduralFlame"
{
	Properties
	{
		...
		_Alpha("Alpha", Range( 0 , 5)) = 1.748938
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult11_g4 = (float2(( _HighFUTiling * ase_objectScale.x ) , ( ase_objectScale.y * _HighFVTiling )));
				float4 matrixToPos17_g4 = float4( GetObjectToWorldMatrix()[0][3],GetObjectToWorldMatrix()[1][3],GetObjectToWorldMatrix()[2][3],GetObjectToWorldMatrix()[3][3]);
				float temp_output_19_0_g4 = ( ( matrixToPos17_g4.x + matrixToPos17_g4.y ) * 3.27 );
				float mulTime15_g4 = _TimeParameters.x * ( _HighFScrollSpeed * _MasterSpeedScalar );
				float2 appendResult3_g4 = (float2(temp_output_19_0_g4 , ( mulTime15_g4 + temp_output_19_0_g4 )));
				float2 texCoord5_g4 = IN.ase_texcoord3.xy * appendResult11_g4 + appendResult3_g4;
				float NoiseHighFreq262 = ( 1.0 - tex2D( _Texture0, texCoord5_g4 ).r );
				float temp_output_293_0 = ( pow( NoiseHighFreq262 , _HighFExp ) * _HighFStr );
				float2 appendResult11_g3 = (float2(( _LowFUTiling * ase_objectScale.x ) , ( ase_objectScale.y * _LowFVTiling )));
				float4 matrixToPos17_g3 = float4( GetObjectToWorldMatrix()[0][3],GetObjectToWorldMatrix()[1][3],GetObjectToWorldMatrix()[2][3],GetObjectToWorldMatrix()[3][3]);
				float temp_output_19_0_g3 = ( ( matrixToPos17_g3.x + matrixToPos17_g3.y ) * 3.27 );
				float mulTime15_g3 = _TimeParameters.x * ( _LowFScrollSpeed * _MasterSpeedScalar );
				float2 appendResult3_g3 = (float2(temp_output_19_0_g3 , ( mulTime15_g3 + temp_output_19_0_g3 )));
				float2 texCoord5_g3 = IN.ase_texcoord3.xy * appendResult11_g3 + appendResult3_g3;
				float NoiseLowFreq263 = ( 1.0 - tex2D( _Texture0, texCoord5_g3 ).r );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime15_g4 = _TimeParameters.x * ( _HighFScrollSpeed * _MasterSpeedScalar );
				float2 appendResult3_g4 = (float2(temp_output_19_0_g4 , ( mulTime15_g4 + temp_output_19_0_g4 )));
				float2 texCoord5_g4 = IN.ase_texcoord2.xy * appendResult11_g4 + appendResult3_g4;
				float NoiseHighFreq262 = ( 1.0 - tex2D( _Texture0, texCoord5_g4 ).r );
				float temp_output_293_0 = ( pow( NoiseHighFreq262 , _HighFExp ) * _HighFStr );
				float2 appendResult11_g3 = (float2(( _LowFUTiling * ase_objectScale.x ) , ( ase_objectScale.y * _LowFVTiling )));
				float4 matrixToPos17_g3 = float4( GetObjectToWorldMatrix()[0][3],GetObjectToWorldMatrix()[1][3],GetObjectToWorldMatrix()[2][3],GetObjectToWorldMatrix()[3][3]);
				...
				float mulTime15_g3 = _TimeParameters.x * ( _LowFScrollSpeed * _MasterSpeedScalar );
				float2 appendResult3_g3 = (float2(temp_output_19_0_g3 , ( mulTime15_g3 + temp_output_19_0_g3 )));
				float2 texCoord5_g3 = IN.ase_texcoord2.xy * appendResult11_g3 + appendResult3_g3;
				float NoiseLowFreq263 = ( 1.0 - tex2D( _Texture0, texCoord5_g3 ).r );
				float saferPower267 = abs( NoiseLowFreq263 );
				float temp_output_280_0 = ( pow( saferPower267 , _LowFExp ) * _LowFStr );
				float CombinedNoise356 = ( ( temp_output_293_0 - temp_output_280_0 ) - ( temp_output_280_0 - temp_output_293_0 ) );
...
/*ASEBEGIN
Version=18935
557;73;1046;756;5111.194;1861.583;2.935406;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;124;-6525.295,-770.7726;Inherit;False;Property;_LocalWindSpeed;LocalWindSpeed;2;0;Create;True;0;0;0;False;0;False;1.572329;0.85;0;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;521;-3822.94,-644.283;Inherit;False;Property;_HighFScrollSpeed;HighF ScrollSpeed;18;0;Create;True;0;0;0;False;0;False;1;-3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;510;-3810.321,-984.7797;Inherit;False;Property;_LowFScrollSpeed;LowF ScrollSpeed;13;0;Create;True;0;0;0;False;0;False;1;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;536;-4127.619,-612.6251;Inherit;False;Property;_MasterSpeedScalar;Master Speed Scalar;0;0;Create;True;0;0;0;False;0;False;1;0.25;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;523;-3814.355,-490.9605;Inherit;False;Property;_HighFVTiling;HighF V Tiling;17;0;Create;True;0;0;0;False;0;False;1;1.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;520;-3791.735,-830.4583;Inherit;False;Property;_LowFVTiling;LowF V Tiling;12;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;519;-3796.735,-906.4581;Inherit;False;Property;_LowFUTiling;LowF U Tiling;11;1;[Header];Create;True;1;Low Freq;0;0;False;0;False;1;0.98;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;522;-3819.355,-566.9612;Inherit;False;Property;_HighFUTiling;HighF U Tiling;16;1;[Header];Create;True;1;High Freq;0;0;False;0;False;1;2.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;562;-3428.847,-945.8157;Inherit;False;ObjectScaledScrollingUV;-1;;3;faf8ebbe3f4cd82438cb724b023b5c38;0;3;6;FLOAT;1;False;7;FLOAT;1;False;8;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;563;-3406.911,-620.9751;Inherit;False;ObjectScaledScrollingUV;-1;;4;faf8ebbe3f4cd82438cb724b023b5c38;0;3;6;FLOAT;1;False;7;FLOAT;1;False;8;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;253;-4079.035,-809.6586;Inherit;True;Property;_Texture0;Texture 0;5;0;Create;True;0;0;0;False;0;False;None;bb911711ee9d6694e892feafd898faca;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;290;-2263.307,-547.4416;Inherit;False;Property;_HighFExp;HighF Exp;19;0;Create;True;0;0;0;False;0;False;1;1.92;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;285;-2273.643,-913.9195;Inherit;False;Property;_LowFExp;LowF  Exp;14;0;Create;True;0;0;0;False;0;False;1;8.5;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;289;-2265.615,-474.1171;Inherit;False;Property;_HighFStr;HighF Str;20;0;Create;True;0;0;0;False;0;False;1;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;282;-2270.114,-837.0552;Inherit;False;Property;_LowFStr;LowF Str;15;0;Create;True;0;0;0;False;0;False;1;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;456;614.2169,-1309.414;Inherit;False;Property;_VertMaskExp;VertMaskExp;10;0;Create;True;0;0;0;False;0;False;4;1.6;0;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;1640.201,285.347;Inherit;False;Property;_Alpha;Alpha;1;0;Create;True;0;0;0;False;0;False;1.748938;1.07;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;318;-5728.795,-557.7411;Inherit;False;Property;_Stretch;Stretch;6;1;[Header];Create;True;1;Stretch scale;0;0;False;0;False;1;0.3;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;206;-1978.196,-1570.408;Inherit;False;Property;_NoiseGradientExponent;NoiseGradientExponent;4;0;Create;True;0;0;0;False;0;False;1;0.5;0.35;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;322;-1527.684,845.7273;Inherit;False;Spherize;-1;;9;1488bb72d8899174ba0601b595d32b07;0;4;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;323;-956.1302,812.9475;Inherit;True;Property;_TextureSample2;Texture Sample 2;8;0;Create;True;0;0;0;False;0;False;-1;None;fcbb22463ab66e3409012b2ef95a3ff0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;315;-5229.401,-302.0298;Inherit;False;Property;_ObjectscaledLerp;Object scaled Lerp;7;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-6538.293,-989.9619;Inherit;False;Property;_TimeInput;TimeInput;3;0;Create;True;0;0;0;False;0;False;0;181.4;0;0;0;1;FLOAT;0
...
WireConnection;538;1;536;0
WireConnection;390;0;389;0
WireConnection;537;0;510;0
WireConnection;537;1;536;0
WireConnection;562;6;537;0
WireConnection;562;7;519;0
WireConnection;562;8;520;0
WireConnection;563;6;538;0
WireConnection;563;7;522;0
WireConnection;563;8;523;0
WireConnection;379;0;390;1
WireConnection;379;1;380;0
WireConnection;374;0;379;0
WireConnection;250;0;253;0
WireConnection;250;1;563;0
WireConnection;239;0;253;0
WireConnection;239;1;562;0
...
ASEEND*/
//CHKSM=9807400C82D99C971AD707112E58BD963F0E10D9