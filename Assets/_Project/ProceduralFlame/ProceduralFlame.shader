	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_381_0 = ( 0.13 * sin( ( break390.y * 3.0 ) ) );
				...
				float mulTime482 = _TimeParameters.x * 0.3;
				float2 appendResult477 = (float2(( break470.x + ( 1.0 - scrollingVSin474 ) ) , ( break470.y + mulTime482 )));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult395 = (float2(( abs( ( break390.x + temp_output_381_0 ) ) * 2.0 ) , texCoord405.y));
				float2 sinUV384 = appendResult395;
				float2 texCoord460 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult459 = (float2(sinUV384.x , pow( texCoord460.y , 4.0 )));
				float2 appendResult316 = (float2(1.0 , _Stretch));
				float2 temp_output_310_0 = ( WindOffsetUV270 * appendResult316 );
				float2 break344 = temp_output_310_0;
...
/*ASEBEGIN
Version=18935
785;73;818;756;-494.0838;685.9136;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;400;-5907.154,-21.09962;Inherit;False;Constant;_Amp;Amp;15;0;Create;True;0;0;0;False;0;False;0.13;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;477;-3962.662,-992.144;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;460;460.008,-479.265;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0E50EDFDD1F8CBAEA36C84F39EF3D525F93F5AEE