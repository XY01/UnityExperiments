...
Shader "ProceduralFlame Parallax"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord592 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( -0.5,-0.1 );
				float temp_output_598_0 = ( 1.0 - length( texCoord592 ) );
				...
				float2 Offset587 = ( ( temp_output_598_0 - 1 ) * ase_tanViewDir.xy * _Paralaxheight ) + texCoord5_g23;
				...
				float2 Offset596 = ( ( temp_output_598_0 - 1 ) * ase_tanViewDir.xy * _LFParalaxheight ) + texCoord5_g24;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord592 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( -0.5,-0.1 );
				float temp_output_598_0 = ( 1.0 - length( texCoord592 ) );
...
/*ASEBEGIN
Version=18935
578;73;725;756;4894.098;1646.113;3.071764;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;592;-3969.789,-1307.489;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;-0.5,-0.1;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LengthOpNode;597;-3704.369,-1309.549;Inherit;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;598;-3518.786,-1296.582;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;356;-687.5675,-670.4678;Inherit;False;CombinedNoise;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=1FF8DA8A79DD11D05C55F19CB2FD014418E10581